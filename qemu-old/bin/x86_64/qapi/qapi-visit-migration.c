...
bool visit_type_MigrationInfo_members(Visitor *v, MigrationInfo *obj, Error **errp)
{
    ...
    if (!visit_type_bool(v, "blocked", &obj->blocked, errp)) {
        return false;
    }
...
bool visit_type_q_obj_migrate_set_downtime_arg_members(Visitor *v, q_obj_migrate_set_downtime_arg *obj, Error **errp)
{
    if (!visit_type_number(v, "value", &obj->value, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_migrate_set_speed_arg_members(Visitor *v, q_obj_migrate_set_speed_arg *obj, Error **errp)
{
...
bool visit_type_q_obj_migrate_set_cache_size_arg_members(Visitor *v, q_obj_migrate_set_cache_size_arg *obj, Error **errp)
{
    if (!visit_type_int(v, "value", &obj->value, errp)) {
        return false;
    }
