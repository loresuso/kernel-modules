...
#line 2 "/home/lore/MasterThesis/qemu/hw/mips/trace-events"
            qemu_log("%d@%zu.%06zu:gt64120_read " "gt64120 read %s size:%u value:0x%08" PRIx64 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , regname, size, value);
#line 37 "trace/trace-hw_mips.h"
        } else {
#line 2 "/home/lore/MasterThesis/qemu/hw/mips/trace-events"
            qemu_log("gt64120_read " "gt64120 read %s size:%u value:0x%08" PRIx64 "\n", regname, size, value);
#line 41 "trace/trace-hw_mips.h"
        }
    }
}
...
static inline void _nocheck__trace_gt64120_write(const char * regname, unsigned size, uint64_t value)
{
    if (trace_event_get_state(TRACE_GT64120_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 3 "/home/lore/MasterThesis/qemu/hw/mips/trace-events"
            qemu_log("%d@%zu.%06zu:gt64120_write " "gt64120 write %s size:%u value:0x%08" PRIx64 "\n",
                     qemu_get_thread_id(),
                     (size_t)_now.tv_sec, (size_t)_now.tv_usec
                     , regname, size, value);
#line 68 "trace/trace-hw_mips.h"
        } else {
#line 3 "/home/lore/MasterThesis/qemu/hw/mips/trace-events"
            qemu_log("gt64120_write " "gt64120 write %s size:%u value:0x%08" PRIx64 "\n", regname, size, value);
#line 72 "trace/trace-hw_mips.h"
        }
    }
}
...
static inline void _nocheck__trace_gt64120_isd_remap(uint64_t from_length, uint64_t from_addr, uint64_t to_length, uint64_t to_addr)
{
    if (trace_event_get_state(TRACE_GT64120_ISD_REMAP) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 4 "/home/lore/MasterThesis/qemu/hw/mips/trace-events"
