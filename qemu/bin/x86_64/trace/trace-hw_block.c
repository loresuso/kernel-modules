...
uint16_t _TRACE_PCI_NVME_COMPARE_CB_DSTATE;
uint16_t _TRACE_PCI_NVME_AIO_DISCARD_CB_DSTATE;
uint16_t _TRACE_PCI_NVME_AIO_ZONE_RESET_CB_DSTATE;
...
uint16_t _TRACE_PCI_NVME_ERR_APPEND_TOO_LARGE_DSTATE;
...
TraceEvent _TRACE_PCI_NVME_COMPARE_CB_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_compare_cb",
    .sstate = TRACE_PCI_NVME_COMPARE_CB_ENABLED,
    .dstate = &_TRACE_PCI_NVME_COMPARE_CB_DSTATE 
};
...
TraceEvent _TRACE_PCI_NVME_AIO_ZONE_RESET_CB_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_aio_zone_reset_cb",
    .sstate = TRACE_PCI_NVME_AIO_ZONE_RESET_CB_ENABLED,
    .dstate = &_TRACE_PCI_NVME_AIO_ZONE_RESET_CB_DSTATE 
};
...
TraceEvent _TRACE_PCI_NVME_ERR_APPEND_TOO_LARGE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_err_append_too_large",
    .sstate = TRACE_PCI_NVME_ERR_APPEND_TOO_LARGE_ENABLED,
    .dstate = &_TRACE_PCI_NVME_ERR_APPEND_TOO_LARGE_DSTATE 
};
...
TraceEvent *hw_block_trace_events[] = {
    ...
    &_TRACE_PCI_NVME_COMPARE_CB_EVENT,
    &_TRACE_PCI_NVME_AIO_DISCARD_CB_EVENT,
    &_TRACE_PCI_NVME_AIO_ZONE_RESET_CB_EVENT,
    ...
    &_TRACE_PCI_NVME_ERR_APPEND_TOO_LARGE_EVENT,
